...
import { ConstraintError } from "../error/ConstraintError";
        ...
        return class SingletonImpl extends target {
            ...
            constructor(...args: any[]) {
                if (target.__singletonHasBeenCreated) {
                    ...
                    throw new ConstraintError(`The singleton class cannot be instantiated twice! Class name was ${target.constructor.name}.`);
                }
